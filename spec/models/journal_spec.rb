...
RSpec.describe Journal do
  ...
  describe 'resource type' do
    it 'has a single valued resource type' do
      ...
      expect(@obj.resource_type).to be_kind_of String
  ...
  describe 'keyword' do
    it 'has a multi valued keyword' do
      ...
      expect(@obj.keyword).to eq ['Data jousubjectrnal keyword']
    end
  end
  ...
  describe 'review process' do
    ...
    it 'indexes the review process' do
      @obj = build(:data_paper, review_process: 'review process')
      @doc = @obj.to_solr
  ...
  describe 'article guidelines' do
    ...
    it 'indexes the article guidelines' do
      @obj = build(:data_paper, article_guidelines: 'Journal publishing guidelines')
      @doc = @obj.to_solr
  ...
  describe 'needs_apc' do
    ...
    it 'indexes needs_apc' do
      @obj = build(:data_paper, needs_apc: 'Yes')
      @doc = @obj.to_solr
  ...
  describe 'apc_statement' do
    ...
    it 'indexes the apc_statement' do
      @obj = build(:data_paper, apc_statement: 'APC statement')
      @doc = @obj.to_solr
  ...
  describe 'oa_statement' do
    it 'has a multi valued oa_statement' do
      ...
      expect(@obj.oa_statement).to eq ['Open sccess statement']
    end

    it 'indexes the oa_statement' do
      @obj = build(:data_paper, oa_statement: 'Open access statement')
      @doc = @obj.to_solr
  ...
  describe 'oa_level' do
    ...
    it 'indexes oa_level' do
      @obj = build(:data_paper, oa_level: 'Green')
      @doc = @obj.to_solr
  ...
  describe 'supported_license' do
    ...
    it 'indexes the supported_license' do
      @obj = build(:data_paper, supported_license: 'License 1')
      @doc = @obj.to_solr
  ...
  describe 'declaration_statement' do
    ...
    it 'indexes the declaration_statement' do
      @obj = build(:data_paper, declaration_statement: 'declaration statement')
      @doc = @obj.to_solr
  ...
  describe 'nested attributes for account' do
    it 'accepts account attributes' do
      @obj = build(:data_paper, account_attributes: [{
            label: 'SwordV2',
      ...
      expect(@obj.account.first.metadata_format).to eq ['DC']
    end
    ...
    it 'indexes the account' do
      ...
      expect(@doc['account_ssm'].size).to eq 2
      expect(@doc['account_type_sim']).to eq ['Sword V2', 'Email']
    end
  end

  describe 'nested attributes for contact' do
    it 'accepts contact attributes' do
      @obj = build(:data_paper, contact_attributes: [{
            label: 'Journal',
    ...
    it 'indexes the contact' do
      ...
      expect(@doc['contact_ssm'].size).to eq 4
      expect(@doc['contact_label_sim']).to eq ['Journal', 'Editor']
    end
  end
